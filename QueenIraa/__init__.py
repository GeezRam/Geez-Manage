...
if ENV:
    ...
    from QueenIraa.config import Development as Config
...
telethn = TelegramClient("QueenIraa", api_id, api_hash)
aiohttpsession = ClientSession()
arq = ARQ(ARQ_API_URL, ARQ_API_KEY, aiohttpsession)
pbot = Client("QueenIraa", api_id, api_hash)
...
from QueenIraa.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
